...
async def sign_in_email_password(email: str, password: str) -> Tuple[str, str, str]:
    """Return (access_token, uid, id_token) using Firebase Authentication."""
    ...
    return access_token, uid, id_token 